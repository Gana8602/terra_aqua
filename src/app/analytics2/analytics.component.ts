...
onSensorChange() {
  ...
  onSubmitAndFetch(): Promise<void> {
    ...
    console.log(`Formatted analysis Fdate: ${formattedFromDate}`);
    console.log(`Formatted analysis Tdate: ${formattedToDate}`);
